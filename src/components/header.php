<header class="fixed top-0 w-full flex justify-between items-center max-w-[1300px] z-50 backdrop-blur-xl py-1">
    ...
    <div>
      <button class="flex gap-2 items-center justify-center text-sm font-medium px-4 py-1.5 rounded-full bg-zinc-900 border-2 border-zinc-600">
        <span class="size-3 rounded-full bg-emerald-400"></span>
        Disonible para trabajar
      </button> 
    </div>
</header>
